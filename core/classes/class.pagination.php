...
class pagination extends coreClass {
    ...
    public function getPagination($showOne=false){
        global $objUser;
    ...
    protected function paginationStyle1(){
		global $objForm;
    ...
    protected function paginationStyle2(){
		$url = $url[0].'?'.$this->getQueryString($_SERVER['REQUEST_URI']);
