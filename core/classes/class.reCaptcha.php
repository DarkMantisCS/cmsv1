    ...
    function outputCaptcha($key){
        $a = array(
    		...
    		'desc'       => '<div id="audio"><a href="#" onclick="Recaptcha.reload(); return false;">Can\'t see the image ?</a><br />'.
								...
								'<div id="image" style="display: none;"><br /><a href="#" onclick="Recaptcha.reload(); return false;">Can\'t hear the sound ?</a><br /><a href="#" onclick="javascript:Recaptcha.switch_type(\'image\'); document.getElementById(\'image\').style.display = \'none\';document.getElementById(\'audio\').style.display = \'block\';">Get image captcha</a></div>',
    	);
