...
$objPage->setTitle(langVar('B_ACP').' > '.langVar('L_MAINTENANCE'));
$objPage->addPagecrumb(array( array('url' => $url, 'name' => langVar('L_MAINTENANCE')) ));
$objTPL->set_filenames(array(
	'body' => 'modules/core/template/panels/panel.settings.tpl'
));

$objTPL->assign_vars(array( 'ADMIN_MODE' => langVar('L_MAINTENANCE')));
...
switch(strtolower($mode)){
	default:
		...
		$objForm->outputForm(array(
			...
			'FORM_TITLE' 	=> langVar('L_MAINTENANCE'),
